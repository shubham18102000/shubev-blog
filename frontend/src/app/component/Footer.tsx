      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-10 border-b border-gray-200">
          <div className="max-w-xl mx-auto text-center">
            <h3 className="text-2xl font-bold mb-3">Stay Charged with Updates</h3>
            <p className="text-gray-500 mb-6">
              Subscribe to our newsletter for the latest EV news, reviews, and charging updates.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              ...
              />
              <button className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-full transition-colors flex items-center justify-center gap-2">
                <span>Subscribe</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 py-10">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-6 mx-auto sm:mx-0">
            ...
            <p className="text-sm text-gray-500 mb-6 text-center sm:text-left">
              Trusted by EV enthusiasts in more than 100 countries & 5 million customers. Have any questions about
              electric vehicles?
            </p>
            <Link
              href="/contact"
              className="flex items-center justify-center sm:justify-start gap-2 py-2.5 px-5 w-fit bg-green-500 hover:bg-green-600 rounded-full text-sm text-white mx-auto sm:mx-0 transition-all duration-300"
            >
          ...
          <div className="text-center sm:text-left">
            <h4 className="text-base font-semibold mb-5">Navigation</h4>
            <ul className="space-y-4 text-sm">
              ...
              <li>
                <Link href="/blog" className="text-gray-600 hover:text-green-500 transition-colors">
                  Blog
                </Link>
              </li>
              <li>
          ...
          <div className="text-center sm:text-left">
            <h4 className="text-base font-semibold mb-5">EV Resources</h4>
            <ul className="space-y-4 text-sm">
              <li>
                <Link href="/ev-reviews" className="text-gray-600 hover:text-green-500 transition-colors">
                  EV Reviews
                </Link>
              </li>
              <li>
                <Link href="/charging-map" className="text-gray-600 hover:text-green-500 transition-colors">
                  Charging Map
                </Link>
              </li>
              <li>
                <Link href="/ev-comparison" className="text-gray-600 hover:text-green-500 transition-colors">
                  EV Comparison
                </Link>
              </li>
              <li>
                <Link href="/buying-guide" className="text-gray-600 hover:text-green-500 transition-colors">
                  Buying Guide
                </Link>
              </li>
            </ul>
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li>
                <Link href="/faq" className="text-gray-600 hover:text-green-500 transition-colors">
                  FAQ
                </Link>
              </li>
            </ul>
          ...
          <div className="text-center sm:text-left">
            <h4 className="text-base font-semibold mb-5">Connect</h4>
            <div className="grid grid-cols-2 gap-3">
              <Link
                href="https://twitter.com"
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center justify-center p-3 rounded-lg bg-gray-100 hover:bg-green-100 transition-colors"
              >
